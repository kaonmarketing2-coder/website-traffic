  ...
  SITES: [
    ...
    },
    {
      ...
      languages: [
        ...
        { code: 'es', label: '스페인어', filterValue: 'lang=es' },
    ...
    },
    {
      ...
      languages: [
        { code: 'all', label: '전체', filterValue: null },
        { code: 'en', label: '영문', filterValue: '/eng' },
        { code: 'ko', label: '국문', filterValue: '/kor' },
        { code: 'es', label: '스페인어', filterValue: '/esp' },
        { code: 'pt', label: '포르투갈어', filterValue: '/por' },
        { code: 'ru', label: '러시아어', filterValue: '/rus' },
      ],
    },
  ],
};
